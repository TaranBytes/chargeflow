  ...
  return (
    <>
      <div className="flex items-center gap-2.5 px-6 h-16 border-b border-slate-200">
        <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-emerald-500 to-emerald-600 grid place-items-center text-white shadow-md shadow-emerald-500/30">
          <Zap className="w-5 h-5" strokeWidth={2.5} />
        </div>
        <div>
          <p className="text-base font-bold text-slate-900 leading-none">ChargeFlow</p>
          <p className="text-[10px] text-slate-500 mt-1 tracking-wide uppercase">EV Network</p>
        </div>
      </div>

      <nav className="flex-1 px-3 py-4 space-y-1 overflow-auto">
        <p className="px-3 pb-2 text-[10px] uppercase tracking-wider text-slate-400 font-semibold">Main</p>
      ...
      <div className="m-3 p-4 rounded-xl bg-gradient-to-br from-emerald-500 to-emerald-700 text-white relative overflow-hidden">
  ...
  return (
    <>
      ...
      <div className={`lg:hidden fixed inset-0 z-40 ${mobileOpen ? '' : 'pointer-events-none'}`}>
        ...
        />
        <aside
          className={`absolute left-0 top-0 bottom-0 w-72 bg-white flex flex-col shadow-xl transition-transform ${
